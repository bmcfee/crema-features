...
if [ ! -d "$src" ]; then
    ...
    pushd $HOME/env
        ...
        if [ "$TRAVIS_PYTHON_VERSION" == "2.7" ] ; then
            pip install https://storage.googleapis.com/tensorflow/linux/cpu/tensorflow-0.7.0-cp27-none-linux_x86_64.whl 
        elif [ "$TRAVIS_PYTHON_VERSION" == "3.4" ] ; then
            pip install https://storage.googleapis.com/tensorflow/linux/cpu/tensorflow-0.7.0-cp34-none-linux_x86_64.whl 
